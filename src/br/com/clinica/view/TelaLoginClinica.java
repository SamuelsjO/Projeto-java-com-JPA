...
public class TelaLoginClinica extends JFrame {
	...
	public TelaLoginClinica() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(TelaLoginClinica.class.getResource("/br/com/clinica/image/login.png")));
		...
		btnExit.setIcon(new ImageIcon(TelaLoginClinica.class.getResource("/br/com/clinica/image/if_cross_16189.png")));

		// logar no sistema da clinica
		...
		btnLogin.setIcon(
				new ImageIcon(TelaLoginClinica.class.getResource("/br/com/clinica/image/if_login_173049.png")));
